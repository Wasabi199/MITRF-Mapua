                            ...
                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <th class="text-left px-16 bg-gray-100">Contribution Amount</th>
                                        <th class="text-left px-16 bg-gray-100">Date Updated</th>
                                                    ...
                                                    <div>
                                                        ...
                                                        -->
                                                            <div class="text-sm font-medium text-gray-900">
                                                                ...
                                                                {{ 
                                                                    contribution.contribution_amount = null ? 'No Contribution' : 'Php '+contribution.contribution_amount
                                                                }}</p>
                                                            </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        -->
                                                            <div class="text-sm font-medium text-gray-900">
                                                                <p class="ml-2 underline">
                                                                {{ 
                                                                    contribution.updated_as = null ? 'n/a' : contribution.updated_as
                                                                }}</p>
                                                            </div>
                                                    </div>
                                                </div>
