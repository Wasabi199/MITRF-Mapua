<template>
    ...
    <div class="grid grid-cols-1 m-8 gap-8 lg:m-10 lg:grid-cols-2   ">
        ...
        <div class="bg-white overflow-hidden border-gray-300 shadow-xl rounded-lg">            
            ...
            <div v-if="loan.approval == 'Processed'" class="bg-white p-4 overflow-hidden border-gray-300 shadow-xl sm:rounded-lg ">
                        ...
                        <div class="justify-between flex">
                            <div class="flex text-lg">
                                ...
                                <p class="ml-2 underline">{{ info.first_name }} {{info.last_name}}</p>
                            </div>
            ...
            <div v-if="loan.approval == 'For Release'" class="bg-white p-4 overflow-hidden border-gray-300 shadow-xl sm:rounded-lg ">
                <div class="mb-8">
                    <div class="flex text-lg">
                        <svg class="h-6 w-6 text-red-900" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div v-if="loan.approval == 'Released'" class="bg-white p-4 overflow-hidden border-gray-300 shadow-xl sm:rounded-lg ">
                <div class="mb-8">
                    <div class="flex text-lg">
                        <svg class="h-6 w-6 text-red-900" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
