            ...
            <div class="p-5">
                ...
                >
                    ...
                    <span class="text-center"
                        >You are about to update {{ userToUpdate.name }}'s
                        account are you sure you want to proceed?</span
                    >
                </div>
        ...
        >
            <div class="p-5">
                ...
                >
                    ...
                    <span class="text-center"
                        >You are about to delete {{ userToDelete.name }}'s
                        account are you sure you want to proceed?</span
                    >
                </div>
                <div class="flex justify-center">
