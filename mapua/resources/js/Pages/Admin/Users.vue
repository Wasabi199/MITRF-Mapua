<template>
    <AppLayout title="Users">
        ...
        <div class="p-2 px-6 leading-tight flex justify-between items-center">
            ...
            <div class="flex-1">
                <Link
                    :href="route('registerUser')"
                    class="text-blue-500 font-semibold text-sm hover:underline ml-4"
                >
                    Register New Member
                </Link>
            </div>
                            ...
                            >
                                <div class="p-5">
                                    ...
                                    <div class="flex justify-center">
                                        ...
                                        <div
                                            class="flex text-xl font-bold dark:text-gray-200 my-3"
                                        >
                                            <div
        ...
        <div class="flex justify-between">
            <form
                ...
                method="post"
                @submit.prevent="verifyUserPasswordFunc"
            >
                ...
                <input
                    ...
                    name="file"
                    type="file"
                    class="border border-yellow-500 hover:bg-yellow-300 rounded-md m-2 p-2 flex items-center ml-12"
                />
                <button
                    type="submit"
                    class="border border-yellow-500 hover:bg-yellow-300 rounded-md m-2 p-2 flex items-center ml-12"
            ...
            <form
                enctype="multipart/form-data"
                method="post"
                @submit.prevent="verifyContriPasswordFunc"
            >
                <h1 class="ml-12">Update Contribution</h1>

                <input
                    @input="formsContri.file = $event.target.files[0]"
                    name="file"
                    type="file"
                    class="border border-yellow-500 hover:bg-yellow-300 rounded-md m-2 p-2 flex items-center ml-12"
                />
        ...
        <Modal
            :closeable="true"
            :show="verifyUserPassword"
            @close="verifyUserPassword = !verifyUserPassword"
        >
            <div class="p-5">
                <div class="flex justify-between">
                ...
                <div class="m-auto w-fit">
                    <button
                        @click="submit"
                        class="border-2 border-green-400 py-3 px-10 mt-5 rounded-lg font-semibold text-lg hover:bg-green-500 hover:text-white"
                    >
                        Verify
                    </button>
                </div>
        ...
        <Modal
            :closeable="true"
            :show="verifyContriPassword"
            @close="verifyContriPassword = !verifyContriPassword"
        >
            <div class="p-5">
                <div class="flex justify-between">
                    <div class="text-2xl font-semibold">Password</div>
                    <div class="">
                        <svg
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                            @click="
                                verifyContriPassword = !verifyContriPassword
                            "
                        >
                            <path
                                d="M6 18L18 6M6 6l12 12"
                ...
                <div class="pt-5">
                    <JetLabel class="text-lg">Password</JetLabel>
                    <JetInput
                        v-model="this.formsContri.password"
                        class="w-full"
                        type="password"
                    />
                </div>
