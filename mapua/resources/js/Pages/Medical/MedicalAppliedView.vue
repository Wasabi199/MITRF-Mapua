        ...
        <div class="bg-white p-4 overflow-hidden border-gray-300 shadow-xl rounded-lg">            
                ...
                <form>
                    <div class="px-2 py-5 bg-white sm:p-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" v-model="name" disabled>
                        </div>

                        <div class="col-span-6 sm:col-span-2">
                            <label class="block text-sm font-medium text-gray-700">Date of Birth</label>
                            <input type="date" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" v-model="birthday" disabled>
                        </div>

                        <div class="col-span-6 sm:col-span-2">
                            <label class="block text-sm font-medium text-gray-700">Age</label>
                            <input type="number" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" v-model="age" disabled>
                        </div>

                        <div class="col-span-6 sm:col-span-2">
                            <label class="block text-sm font-medium text-gray-700">Date of Employment</label>
                            <input type="date" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" v-model="employment" disabled>
                        </div>

                        <div class="col-span-6 sm:col-span-2">
                            <label class="block text-sm font-medium text-gray-700">Years of Service</label>
                            <input type="number" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" v-model="service" disabled>
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <input type="text" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" v-model="department" disabled>
                        </div>

                        <div class="col-span-6 sm:col-span-3">
                            <label class="block text-sm font-medium text-gray-700">Amount of Reimbursment</label>
                            <input type="number" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" v-model="amount" disabled>
                        </div>
         ...
         <div  class="row-span-3">    
                    ...
                    <div class="bg-white shadow-xl rounded-lg content-center lg:mr-50 "> 
                        <img :src="userMedical.medical_record1 == null ? '' : userMedical.medical_record1 " class="w-auto h-auto" >
                    </div>
                    <div class="bg-white shadow-xl rounded-lg content-center lg:mr-50 "> 
                         <img :src="userMedical.medical_record2 == null ? '' : userMedical.medical_record2 " class="w-auto h-auto" >
                    </div>
                    <div class="bg-white shadow-xl rounded-lg content-center lg:mr-50 "> 
                        <img :src="userMedical.medical_record3 == null ? '' : userMedical.medical_record3 " class="w-auto h-auto" >
                    </div>
                    <div class="bg-white shadow-xl rounded-lg content-center lg:mr-50 "> 
                        <img :src="userMedical.medical_record4 == null ? '' : userMedical.medical_record3 " class="w-auto h-auto" >
                    </div>
                <br>
                <div v-if="userMedical.status == 'Pending'" class="w-full p-0 m-0 flex items-center       justify-center gap-20">
                        <button  type="button" class=" py-2 px-4 mb-5 bg-red-600 hover:bg-red-700 focus:ring focus:ring-red-300 text-white w-64 
                            transition ease-in duration-150 text-lg text-center font-semibold shadow-md rounded-lg" @click="rejectMedical(userMedical)">Reject</button>
    
                        <button type="button" class=" py-2 px-4 mb-5 bg-green-600 hover:bg-green-700 focus:ring focus:ring-green-300 text-white w-64 
                            transition ease-in duration-150 text-lg text-center font-semibold shadow-md rounded-lg" @click="acceptMedical(userMedical)">Accept</button>
                </div>
            </div>
    </div>
 ...
 <Modal :closeable="true" :show="showApproveModal"
        ...
        <div class="p-5">
            ...
            <div class="flex flex-col items-center text-xl font-bold text-gray-900 my-3">
                ...
                <span class="text-center">Approve {{ userProfile.first_name }} {{userProfile.last_name}} Medical Reimbursment?</span>
            </div>
...
<Modal :closeable="true" :show="showRejectModal"
        ...
        <div class="p-5">
            ...
            <div class="flex flex-col items-center text-xl font-bold text-gray-900 my-3">
                ...
                <span class="text-center">Reject {{ userProfile.first_name }} {{userProfile.last_name}} Medical Reimbursment?</span>
            </div>
            <div class="flex justify-center">
...
export default {
    ...
    data(){
        return{
            ...
            age: new Date().getUTCFullYear() - new Date(this.$props.userProfile.birth_date).getUTCFullYear(),
            employment:this.$props.userProfile.employment,
            service:new Date().getUTCFullYear() - new Date(this.$props.userProfile.employment).getUTCFullYear(),
